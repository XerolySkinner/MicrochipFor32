 ...
 */
bscpp_IIC_STM32::bscpp_IIC_STM32(GPIO_TypeDef *GPIOx_SCK,uint16_t GPIO_Pin_SCK,GPIO_TypeDef *GPIOx_SDA,uint16_t GPIO_Pin_SDA){
	bscpp_IIC_STM32::GPIOx_SCK=GPIOx_SCK;
	bscpp_IIC_STM32::GPIO_Pin_SCK=GPIO_Pin_SCK;
	bscpp_IIC_STM32::GPIOx_SDA=GPIOx_SDA;
	bscpp_IIC_STM32::GPIO_Pin_SDA=GPIO_Pin_SDA;}
//////////////////////////////////////////////////////////////////////////////////////////////////////
//----------------------------------------------------------------------------------------------------
//	适配程序
//	
 ...
 *					在此处短暂延时
 */ 
void bscpp_IIC_STM32::IIC_Delay(void) {
	u8 i = 0;
	while (++i);}
/**
 * @brief			控制SCK管脚口
 ...
 */ 
u8 bscpp_IIC_STM32::IIC_SCK(u8 var) {
	if (var == IIC_RESET) {
 ...
 * @return			当var为IIC_READ时返回管脚状态
 */ 
u8 bscpp_IIC_STM32::IIC_SDA(u8 var) {
	if (var == IIC_RESET) {
