 ...
 */ 
class bscpp_STM32_OLED :
    protected bscpp_IIC_STM32{
	public:
		bscpp_STM32_OLED(bscpp_IIC_STM32 &IICS):bscpp_IIC_STM32(
			IICS.GPIOx_SCK,IICS.GPIO_Pin_SCK,
			IICS.GPIOx_SDA,IICS.GPIO_Pin_SDA
			){;};
		bscpp_STM32_OLED(GPIO_TypeDef *GPIOx_SCK,uint16_t GPIO_Pin_SCK,GPIO_TypeDef *GPIOx_SDA,uint16_t GPIO_Pin_SDA):bscpp_IIC_STM32(
